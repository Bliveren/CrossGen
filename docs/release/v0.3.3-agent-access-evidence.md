...
> Status: archived development evidence. The v0.3.3 release is public; this file
> records the candidate work. Final release evidence is in `docs/release/evidence.json`.
>
> Updated: 2026-09-02
...
The original candidate draft intentionally did not claim the following:
...
Those gates were subsequently recorded against the exact candidate commit and
package hash in `docs/release/evidence.json` before publishing `v0.3.3`.
