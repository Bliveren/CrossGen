...
Status: retracted to draft on 2026-07-14 before product-owner acceptance.

`v0.3.1` must not be treated as a completed public release. The GitHub Release
was converted back to draft and `docs/updates/latest.json` was restored to the
last approved release, `0.3.0`, after product testing found release-blocking
image-to-image timeout behavior. The evidence below is retained as historical
packaging evidence only; it is not release approval.

Release tag:

- `v0.3.1`
- Commit: `20cb2f9fff350910fa2bd89b237347fc218f6d56`
- Release: draft only; not publicly approved
...
`docs/updates/latest.json` no longer advertises `0.3.1`. It was restored to
`0.3.0` as part of the retraction. Before `0.3.1` may be republished, product
owner acceptance must be recorded and the manifest must be regenerated from the
new approved release assets.

The withdrawn manifest previously pointed to these installer assets:
