...
Status: release candidate withdrawn on 2026-07-14. `docs/release/v0.3.1-evidence.json`
records candidate 0.3.1 evidence gathered before product acceptance; `docs/release/evidence.json`
is the active 0.3.1 ledger and now includes a blocked product-owner acceptance
gate.
...
- [ ] Obtain explicit product-owner approval after local installable package testing.
