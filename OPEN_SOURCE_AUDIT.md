...
| Multi-provider scope | Documented | README, ARCHITECTURE, SECURITY, EXTERNAL_ACCEPTANCE, and RELEASE_NOTES describe GPT Image 2, Nano Banana 3, and General boundaries. General remains documented as Gemini-only fallback on main, avoiding unverified any-provider claims. |
