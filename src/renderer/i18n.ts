...
export const translations: Record<Language, UiCopy> = {
  en: {
    ...
    apiAccess: "Configuration",
    apiAccessName: "Configuration name",
    apiAccessList: "Saved configurations",
    addApiAccess: "Add configuration",
    addingApiAccess: "Adding",
    switchApiAccess: "Use this configuration",
    currentApiAccess: "Current configuration",
    deleteApiAccess: "Delete configuration",
    deleteLastApiAccessDisabled: "At least one configuration must remain.",
    confirmDeleteApiAccess: (name: string) => `Delete configuration "${name}"? Saved key and model discovery for this configuration will be removed.`,
    apiAccessAdded: "Configuration added.",
    apiAccessDeleted: "Configuration deleted.",
    apiAccessSwitched: (name: string) => `Switched to ${name}.`,
    apiAccessUntitled: "Untitled configuration",
    apiAccessKind: "Configuration type",
  ...
  zh: {
    ...
    apiAccess: "配置",
    apiAccessName: "配置名称",
    apiAccessList: "已保存的配置",
    addApiAccess: "添加配置",
    addingApiAccess: "添加中",
    switchApiAccess: "使用此配置",
    currentApiAccess: "当前配置",
    deleteApiAccess: "删除配置",
    deleteLastApiAccessDisabled: "至少需要保留一个配置。",
    confirmDeleteApiAccess: (name: string) => `确认删除配置“${name}”？该配置保存的 Key 和模型探测结果会一并移除。`,
    apiAccessAdded: "配置已添加。",
    apiAccessDeleted: "配置已删除。",
    apiAccessSwitched: (name: string) => `已切换到 ${name}。`,
    apiAccessUntitled: "未命名配置",
    apiAccessKind: "配置类型",
    apiAccessBaseURLSummary: "Base URL",
